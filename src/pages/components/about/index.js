  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about Code Shine Technology. Discover our mission, expertise in web development, and why businesses choose us for innovative solutions. Let’s build the future together."
        />
        <meta
          name="keywords"
          content="web development, front-end development, back-end development, full stack development, Code Shine Technology"
        />
      ...
      <div className="">
        <div className="max-w-[1500px] mx-auto shadow-lg">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-serif">
            ...
            <p className="text-3xl md:text-5xl text-center leading-relaxed mb-6">
              Welcome to{" "}
              <span className="font-semibold text-blue-600">
                Code Shine Technology
              </span>
              !
            </p>
            ...
            <div className="mb-8">
              <img
                src="/team.jpg" // Replace with your image URL
                alt="Our Team"
            ...
            <p className="text-lg leading-relaxed mb-6">
              ...
              innovative web development solutions. With a team of skilled
              professionals, we specialize in creating visually stunning,
              user-friendly, and highly functional websites that drive success
              for our clients.
            </p>
            ...
            <p className="text-lg leading-relaxed mb-6">
              ...
              transform and elevate brands, making them stand out in a
              competitive market.
            </p>
            ...
            <ul className="list-disc list-inside text-lg leading-relaxed mb-6">
              <li>
                ...
                CSS, JavaScript, React.js, Next.js, Bootstrap, Tailwind CSS, and
                various CSS libraries.
              </li>
              <li>
                <span className="font-semibold text-blue-600">
                  Back-End Development:
                </span>{" "}
                Building robust and scalable solutions with Node.js, Express,
            ...
            <ul className="list-disc list-inside text-lg leading-relaxed mb-6">
              <li>
                ...
                strategists dedicated to delivering the best results.
              </li>
              <li>
                <span className="font-semibold text-blue-600">
            ...
            <p className="text-lg leading-relaxed mb-6">
              ...
              life. Whether you are a startup, a small business, or an
              established enterprise, we have the expertise and passion to help
              you succeed.
            </p>
